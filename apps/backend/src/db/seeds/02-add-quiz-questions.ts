...
async function seed(knex: Knex): Promise<void> {
	...
	await knex(DatabaseTableName.QUESTION_OPTIONS).insert([
		...
		// General Questions Options (shifted IDs)
