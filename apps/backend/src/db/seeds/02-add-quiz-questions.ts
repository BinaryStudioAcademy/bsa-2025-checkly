...
async function seed(knex: Knex): Promise<void> {
	...
	await knex(DatabaseTableName.QUESTIONS_CATEGORIES).insert([
		...
		{ category_id: 4, order: 4, question_id: 16 },
		...
		{ category_id: 4, order: 5, question_id: 17 },
		...
		{ category_id: 2, order: 8, question_id: 19 },
